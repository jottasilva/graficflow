/**
 * Permissions module — fonte única de verdade compartilhada entre frontend e backend.
 * Este arquivo duplica as definições do backend para evitar acoplamento de paths em
 * tempo de build/deploy. Qualquer alteração deve ser espelhada em
 * backend/src/shared/permissions.ts (ou vice-versa).
 */
